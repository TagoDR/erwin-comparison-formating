...
`,fr=R(`dark`),pr=()=>{let e=fr.get()===`dark`?`light`:`dark`;fr.set(e),document.documentElement.setAttribute(`data-theme`,e)};document.documentElement.setAttribute(`data-theme`,fr.get());var mr=`:host {
  display: block;
  position: sticky;
  top: 0;
  z-index: 1000;
