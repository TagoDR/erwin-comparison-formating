...
- **Character Counter**: Real-time length indicators (color-coded) for all name fields (Entities, Tables, Collections, Attributes, Columns, and Fields) on both models (Green ≤ 18, Red > 18).
...
- **Visual Feedback**: Copy-to-clipboard actions provide instant visual confirmation with an **green** checkmark.
