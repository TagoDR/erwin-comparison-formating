...
_Example:_ A "Foreign Keys" identification row (not the grouping row) at Level 2 indentation will use the Level 2 color (#FBD5B5). Grouping rows remain uncolored.
...
- **File Name:** `Erwin_Formatter_CompleteCompare.html`
